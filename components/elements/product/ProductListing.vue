    ...
    <div class="ps-product ps-product--list" v-if="product">
        <div class="ps-product__content">
            ...
            <div class="ps-product__info">
                ...
                <div class="ps-product__rating">
                    ...
                    <span class="ps-product__review">(Calificaciónes)</span>
                </div>
        ...
        <div class="ps-product__footer">
            ...
            <div class="ps-product__quantity">
                ...
                <a class="ps-btn ps-btn--primary" href="#" @click.prevent="addToCart()">Añadir al carrito</a>
            </div>
            <div class="ps-product__variations">
                <a class="ps-product__link" href="#" @click.prevent="addProductToWishlist()">Añadir a la lista de deseos</a>
                <a class="ps-product__link" href="#" @click.prevent="addProductCompare()">Comparar</a>
            </div>
        </div>
    </div>
</template>
