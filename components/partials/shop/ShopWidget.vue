<template>
    <div class="ps-widget ps-widget--product">
        <div class="ps-widget__block">
            <h4 class="ps-widget__title">Categorias</h4>
        ...
        <div class="ps-widget__block">
            <h4 class="ps-widget__title">Por precio</h4>
        ...
        <div class="ps-widget__block">
            <h4 class="ps-widget__title">Marcas</h4>
        ...
        <div class="ps-widget__block">
            <h4 class="ps-widget__title">Calificaciones</h4>
