<template>
    <header
        :class="['ps-header ps-header--3', { 'ps-header--sticky': sticky }]"
    >
        <notification />
        ...
        <div class="ps-header__middle">
            <div class="container">
                ...
                <div class="ps-header__right">
                    <ul class="ps-header__icons ml-5">
                        <li class="ps-header__user">
                            
                          <nuxt-link to="/account/my-account#" class=" active ps-header__item">
            ...
            <div class="container pb-1 mt-2 ps-header__menu-container">
                <div class="ps-header__menu container pb-1 mt-2">
