            ...
            <div class="row">
                <div class="col-12 col-sm-6">
                    <div class="ps-form--review">
                        <h2 class="ps-form__title">Mi cuenta</h2>
                        ...
                        <div class="ps-form__group">
                            <label class="ps-form__label">Contraseña *</label>
                            <v-text-field
                                class="form-control ps-form__input"
                        ...
                        <div class="ps-form__submit">
                            <button class="ps-btn ps-btn--primary" @click="handleLogin()">
                                Ingresar
                            </button>
                ...
                <div class="col-12 col-sm-6">
                    <div class="ps-form--review">
                        <h2 class="ps-form__title">Registrarme</h2>
                        <div class="ps-form__group">
                            <label class="ps-form__label"
                                >Email  *</label
                            >
                        ...
                        <div class="ps-form__group">
                            ...
                            <p class="ps-form__text">
                                Sugerencia: la contraseña debe tener al menos doce
                                 caracteres largos. Para hacerlo más fuerte, use mayusculas y minúsculas, números y símbolos.
                            </p>
                        </div>
                        <div class="ps-form__submit">
                            <button class="ps-btn ps-btn--primary" @click="handleRegister()">
                                Continuar
                            </button>
                        </div>
                    </div>
