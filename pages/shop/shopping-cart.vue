<template>
    <div class="ps-shopping">
        <div class="container">
            ...
            <h3 class="ps-shopping__title">Carrito de compras<sup>({{ productCartQuantity }})</sup></h3>
            <div class="ps-shopping__content">
                <div class="row">
                    <div class="col-12 col-sm-7 col-md-9">
                            ...
                            <table class="table ps-table ps-table--product">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="ps-product__name">Nombre del producto</th>
                                        <th class="ps-product__meta">Precio unitario</th>
                        ...
                        <div class="ps-shopping__footer">
                            <div class="ps-shopping__coupon">
                                ...
                                />
                                <button class="ps-btn ps-btn--secondary" type="button" @click="handleCoupon()">Aplicar cupón</button>
                            </div>
                    ...
                    <div class="col-12 col-sm-5 col-md-3">
                        <div class="ps-shopping__label">Resumen</div>
                        <div class="ps-shopping__box">
                            ...
                            <div class="ps-shopping__checkbox">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="cart-free-ship">Envío gratis</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" id="cart-ship">
                                    <label class="form-check-label" for="cart-ship">Recogida en el local: $10.00</label>
                                </div>
                            </div>
                            <div class="ps-shopping__text">Las opciones de envío se actualizarán durante el pago.</div>
                            ...
                            <div class="ps-shopping__checkout">
                                <nuxt-link class="ps-btn ps-btn--primary" to="/shop/checkout">Comprar</nuxt-link>
                                <nuxt-link class="ps-shopping__link" to="/shop">Continuar comprando</nuxt-link>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <latest-product-carousel title="Te puede interesar ..." :dataList="latestProduct" />
    </div>
</template>
